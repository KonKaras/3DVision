...
class InferenceHelper:
    def __init__(self, custom, dataset='nyu', device='cuda:0'):
        ...
        if dataset == 'nyu':
            ...
            if custom:
                model = UnetAdaptiveBinsPretrained.build(n_bins=256, min_val=self.min_depth, max_val=self.max_depth)
                pretrained_path = "./checkpoints/AdabinsBathNoChamferLR0001_01-Feb_16-21-nodebs4-tep25-lr0.0001-wd0.1-ed7bd937-1672-4554-a0f0-cce0ca2b28b0_best.pt"
