...
from models import UnetAdaptiveBins, UnetAdaptiveBinsPretrained
...
if __name__ == '__main__':
    ...
    model = UnetAdaptiveBinsPretrained.build(n_bins=args.n_bins, min_val=args.min_depth, max_val=args.max_depth,
