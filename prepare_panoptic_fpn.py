# https://github.com/facebookresearch/detectron2/blob/main/datasets/prepare_panoptic_fpn.py
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
if __name__ == "__main__":
    ...
    for s in [
        ...
        separate_coco_semantic_from_panoptic(
            os.path.join(dataset_dir, "annotations/panoptic_{}_superid.json".format(s)),
